...
import Bourdillon1 from "../Components/Assets/Bourdillon/BOU1.jpg";
import Bourdillon2 from "../Components/Assets/Bourdillon/BOU2.jpg";
import Bourdillon3 from "../Components/Assets/Bourdillon/BOU3.jpg";
import Bourdillon4 from "../Components/Assets/Bourdillon/BOU4.jpg";


const ProjPicBourdillon = () => {
  return (
    <>
      <section className="sectionProjectPic">
        <div className="divProjPicLanding">
          ...
          <div className="divImageText">
            <h1 className="headingImage">BOURDILLON</h1>
        ...
        <div className="divProjPicMain">
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={Bourdillon1} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={Bourdillon2} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={Bourdillon3} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={Bourdillon4} className="projPicImageOf" />
          </div>
        </div>
      </section>
    </>
