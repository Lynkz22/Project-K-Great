...
import Gmunu1 from "../Components/Assets/Gmunu/GMR1.jpg";
import Gmunu2 from "../Components/Assets/Gmunu/GMR2.jpg";
import Gmunu3 from "../Components/Assets/Gmunu/GMR3.jpg";
import Gmunu4 from "../Components/Assets/Gmunu/GMR4.jpg";
import Gmunu5 from "../Components/Assets/Gmunu/GMR5.jpg";
      ...
      <section className="sectionProjectPic">
        <div className="divProjPicLanding">
          ...
          <div className="divImageText">
            <h1 className="headingImage">GMUNU</h1>
            <h1 className="headingImage1">BANANA ISLAND, LAGOS</h1>
        ...
        <div className="divProjPicMain">
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={Gmunu1} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={Gmunu2} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={Gmunu3} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={Gmunu4} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={Gmunu5} className="projPicImageOf" />
          </div>
        </div>
      </section>
    </>
