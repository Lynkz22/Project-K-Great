...
import MarieStopesLekki1 from "../Components/Assets/MarieStopes/MS1.png";
import MarieStopesLekki2 from "../Components/Assets/MarieStopes/MS2.png";
import MarieStopesLekki3 from "../Components/Assets/MarieStopes/MS3.png";
import MarieStopesLekki4 from "../Components/Assets/MarieStopes/MS4.png";
import MarieStopesLekki5 from "../Components/Assets/MarieStopes/MS5.png";



const ProjPicMarieStopesLekki = () => {
  return (
    <>
      <section className="sectionProjectPic">
        <div className="divProjPicLanding">
          ...
          <div className="divImageText">
            <h1 className="headingImage">MARIE STOPES, LEKKI</h1>
        ...
        <div className="divProjPicMain">
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MarieStopesLekki1} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MarieStopesLekki2} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MarieStopesLekki3} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MarieStopesLekki4} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MarieStopesLekki5} className="projPicImageOf" />
          </div>
...
export default ProjPicMarieStopesLekki;
