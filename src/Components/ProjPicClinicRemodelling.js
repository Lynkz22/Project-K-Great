...
import ClinicRemodelling1 from "../Components/Assets/ClinicRen/CR1.png";
import ClinicRemodelling2 from "../Components/Assets/ClinicRen/CR2.png";
import ClinicRemodelling3 from "../Components/Assets/ClinicRen/CR3.png";
import ClinicRemodelling4 from "../Components/Assets/ClinicRen/CR4.png";
import ClinicRemodelling5 from "../Components/Assets/ClinicRen/CR5.png";


const ProjPicClinicRemodelling = () => {
  return (
    <>
      <section className="sectionProjectPic">
        <div className="divProjPicLanding">
          ...
          <div className="divImageText">
            <h1 className="headingImage">CLINIC REMODELLING</h1>
            <h1 className="headingImage1">ABUJA</h1>
        ...
        <div className="divProjPicMain">
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={ClinicRemodelling1} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={ClinicRemodelling2} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={ClinicRemodelling3} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={ClinicRemodelling4} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={ClinicRemodelling5} className="projPicImageOf" />
          </div>
        </div>
      </section>
    </>
