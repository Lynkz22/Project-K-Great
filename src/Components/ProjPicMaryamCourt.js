...
import MaryamCourt1 from "../Components/Assets/Maryam-Court/MC1.jpg";
import MaryamCourt2 from "../Components/Assets/Maryam-Court/MC2.jpg";
import MaryamCourt3 from "../Components/Assets/Maryam-Court/MC3.jpg";
import MaryamCourt4 from "../Components/Assets/Maryam-Court/MC4.jpg";


const ProjPicMaryamCourt = () => {
  return (
    <>
      <section className="sectionProjectPic">
        <div className="divProjPicLanding">
          ...
          <div className="divImageText">
            <h1 className="headingImage">MARYAM COURT</h1>
        ...
        <div className="divProjPicMain">
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MaryamCourt1} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MaryamCourt2} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MaryamCourt3} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MaryamCourt4} className="projPicImageOf" />
          </div>
