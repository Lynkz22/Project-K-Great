...
import Ogudu1 from "../Components/Assets/Ogudu/OG1.jpg";
import Ogudu2 from "../Components/Assets/Ogudu/OG2.jpg";
import Ogudu3 from "../Components/Assets/Ogudu/OG3.jpg";
import Ogudu4 from "../Components/Assets/Ogudu/OG4.jpg";
      ...
      <section className="sectionProjectPic">
        <div className="divProjPicLanding">
          ...
          <div className="divImageText">
            <h1 className="headingImage">OGUDU</h1>
            <h1 className="headingImage1">OGUDU</h1>
        ...
        <div className="divProjPicMain">
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={Ogudu1} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={Ogudu2} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={Ogudu3} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={Ogudu4} className="projPicImageOf" />
          </div>
        </div>
      </section>
    </>
