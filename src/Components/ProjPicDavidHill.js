...
import DavidHill1 from "../Components/Assets/David's-Hill/DH1.jpg";
import DavidHill2 from "../Components/Assets/David's-Hill/DH2.jpg";
import DavidHill3 from "../Components/Assets/David's-Hill/DH3.jpg";
import DavidHill4 from "../Components/Assets/David's-Hill/DH4.jpg";
import DavidHill5 from "../Components/Assets/David's-Hill/DH5.jpg";


const ProjPicDavidHill = () => {
    return (
        <>
            <section className="sectionProjectPic">
                <div className="divProjPicLanding">
                    ...
                    <div className="divImageText">
                        <h1 className="headingImage">DAVID'S HILL</h1>
            ...
            design to meet industry energy efficiency standards.
                ...
                <div className="divProjPicMain">
                    <div className="divProjectImagesOf">
                        <img alt="HeroImg" src={DavidHill1} className="projPicImageOf" />
                    </div>
                    <div className="divProjectImagesOf">
                        <img alt="HeroImg" src={DavidHill2} className="projPicImageOf" />
                    </div>
                    <div className="divProjectImagesOf">
                        <img alt="HeroImg" src={DavidHill3} className="projPicImageOf" />
                    </div>
                    <div className="divProjectImagesOf">
                        <img alt="HeroImg" src={DavidHill4} className="projPicImageOf" />
                    </div>
                    <div className="divProjectImagesOf">
                        <img alt="HeroImg" src={DavidHill5} className="projPicImageOf" />
                    </div>
                </div>
            </section>
        </>
...
export default ProjPicDavidHill;
