...
import MarieStopesBenin1 from "../Components/Assets/MarieStopesBenin/MS.png";
import MarieStopesBenin2 from "../Components/Assets/MarieStopesBenin/MS1.png";
import MarieStopesBenin3 from "../Components/Assets/MarieStopesBenin/MS2.png";
import MarieStopesBenin4 from "../Components/Assets/MarieStopesBenin/MS3.png";
import MarieStopesBenin5 from "../Components/Assets/MarieStopesBenin/MS4.png";

const ProjPicMarieStopesBenin = () => {
  return (
    <>
      <section className="sectionProjectPic">
        <div className="divProjPicLanding">
          ...
          <div className="divImageText">
            <h1 className="headingImage">MARIE STOPES, BENIN</h1>
            <h1 className="headingImage1">BENIN</h1>
        ...
        <div className="divProjPicMain">
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MarieStopesBenin1} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MarieStopesBenin2} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MarieStopesBenin3} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MarieStopesBenin4} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MarieStopesBenin5} className="projPicImageOf" />
          </div>
...
export default ProjPicMarieStopesBenin;
