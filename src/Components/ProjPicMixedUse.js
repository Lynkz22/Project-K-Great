...
import MixedUse1 from "../Components/Assets/Mixed-Use/MUD1.jpg";
import MixedUse2 from "../Components/Assets/Mixed-Use/MUD2.jpg";

const ProjPicMixedUse = () => {
  return (
    <>
      <section className="sectionProjectPic">
        <div className="divProjPicLanding">
          ...
          <div className="divImageText">
            <h1 className="headingImage">MIXED USE DEVELOPMENT</h1>
        ...
        <div className="divProjPicMain">
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MixedUse1} className="projPicImageOf" />
          </div>
          <div className="divProjectImagesOf">
            <img alt="HeroImg" src={MixedUse2} className="projPicImageOf" />
          </div>
